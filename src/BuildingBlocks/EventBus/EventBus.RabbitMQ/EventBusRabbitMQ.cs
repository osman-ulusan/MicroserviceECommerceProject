    ...
    public class EventBusRabbitMQ : BaseEventBus
    {
        ...
        public override void Publish(IntegrationEvent @event)
        {
            ...
            var policy = Policy.Handle<BrokerUnreachableException>()
                .Or<SocketException>()
                .WaitAndRetry(EventBusConfig.ConnectionRetryCount, retryCount => TimeSpan.FromSeconds(Math.Pow(2, retryCount)), (ex, time) =>
                {
                    //log
                });
            ...
            policy.Execute(() =>
            {
                ...
                //bu satırları kaldırdık çünkü publish metodu mesajı ilgili exchange göndereceğiz, buradan hangi kuyruklara göndeceğine buraya subscribe edenlere gönderecek.
        ...
        private async void Consumer_Received(object sender, BasicDeliverEventArgs eventArgs)
        {
            ...
            consumerChannel.BasicAck(eventArgs.DeliveryTag, multiple: true);
        }
    }
}
