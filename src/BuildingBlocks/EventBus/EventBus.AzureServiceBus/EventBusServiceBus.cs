...
namespace EventBus.AzureServiceBus
{
    public class EventBusServiceBus : BaseEventBus
    {
        ...
        public override void Subscribe<T, TH>()
        {
            ...
            if (!SubsManager.HasSubscriptionsForEvent(eventName)) //eğer subscription yok ise
            {
                //azure service bus tarafında oluşturulması

                //azure tarafında varmı yokmu subscription onuda kontrol ediyoruz
        ...
        private async void RegisterSubscriptionClientMessageHandler(ISubscriptionClient subscriptionClient)
        {
        ...
        private ISubscriptionClient CreateSubscriptionClientIfNotExists(string eventName)
        {
            ...
            if (!exists) // ilk defa geliyorsa önce oluştur sonra azurda oluşan default rulesleri sil
            {
